...
|-----------+------+------+------+------+-------------+------+------+------+------+------|
| hold Ctrl |      |      |      |      |      |      |      |      |      |      |      |
| tap Esc   |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  "   |
|-----------+------+------+------+------+------|------+------+------+------+------+------|
| Shift     |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
|-----------+------+------+------+------+------+------+------+------+------+------+------|
| Brite     | Ctrl | Alt  | GUI  |    Space    |Lower |Raise | Left | Down |  Up  |Right |
`----------------------------------------------------------------------------------------'
 */
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  BACKLIT,        KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  LOWER,   RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
